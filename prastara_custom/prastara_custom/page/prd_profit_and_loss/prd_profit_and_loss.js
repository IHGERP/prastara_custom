frappe.pages['prd-profit-and-loss'].on_page_load = function(wrapper) {
	...
	function formatCurrency(value) {
		...
		if (absValue >= 1000000) { // 1 Million
			formatted = 'AED ' + (absValue / 1000000).toFixed(1) + 'M';
		} else if (absValue >= 1000) { // 1 Thousand
			formatted = 'AED ' + (absValue / 1000).toFixed(1) + 'K';
		} else {
			formatted = 'AED ' + absValue.toLocaleString('en-AE');
		}
